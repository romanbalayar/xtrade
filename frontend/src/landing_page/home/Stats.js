        ...
        <div className='contaier p-3'>
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'>That's why 1.5+ million customers trust
                         with $98 billions worth of equity investments.
                    </p>
                    <h2 className='fs-4'>No spam or gimmicks</h2>
                    <p className='text-muted'>No gimmicks, spam, "gamification", or annoying push notifications.
                         High quality apps that you use at your pace, the way you like.
                    </p>
                    <h2 className='fs-4'>The Xtrading universe</h2>
                ...
                <div className='col-6 p-5'>
                    <img src='media/images/stats.png' style={{width:'93%'}}></img>
                    <div className='text-center '>
                        <a href='' className='mx-3' style={{textDecoration:"none"}}>Explore <i class="fa fa-long-arrow-right"
                         aria-hidden="true"></i></a>

                        <a href=''  style={{textDecoration:"none"}}>Fly Kite <i class="fa fa-long-arrow-right"
                         aria-hidden="true"></i></a>
                    </div>
                </div>
